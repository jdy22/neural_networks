...
class Regressor():
    ...
    def __init__(self, x, nb_epoch = 1000, learning_rate = 0.1, nb_layers = 1, nb_neurons = 23, activation = "tanh"):
        ...
        """
        self.x =x # for initialising new regressor in hyperparam tuning 
...
def example_main():
    ...
    # Training
    regressor = Regressor(x_train, nb_epoch = 1000, learning_rate = 0.05, nb_layers = 4, nb_neurons = 5, activation = "relu")
